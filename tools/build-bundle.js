...
const README = [
  ...
  '  You should have a short ROOT value stored with your shards (printed on the',
  '  shard cards). Verify before trusting anything here:',
  '',
  ...
  '  at least a quorum of your shards (one per line), add the recovery envelope if',
  '  you used encrypted mode, and press Recover.',
  '',
